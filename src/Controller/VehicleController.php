...
class VehicleController extends AbstractController
{
     ...
     */
    public function index(SerializerInterface $serializer, VehicleRepository $vehicleRepository): Response
    {
        return new JsonResponse($serializer->serialize($vehicleRepository->findAll(), 'json'), 200, [
